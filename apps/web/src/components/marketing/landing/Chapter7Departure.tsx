  ...
  return (
    <section className="relative h-[80vh] bg-black flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl px-6 flex flex-col items-center">
        ...
        <Link 
          href="/signup"
          className="inline-flex items-center justify-center space-x-3 text-sm font-bold text-slate-900 bg-white px-10 py-5 rounded-full hover:bg-slate-200 transition-all shadow-[0_0_50px_rgba(255,255,255,0.3)] hover:shadow-[0_0_80px_rgba(255,255,255,0.5)] transform hover:scale-105"
        >
          Start Planning Now
        </Link>
