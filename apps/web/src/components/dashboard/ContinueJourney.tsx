...
export function ContinueJourney({ trips = [] }: ContinueJourneyProps) {
  const router = useRouter();

  // If no trips provided via props, show a beautiful empty state
  const displayTrips = trips.length > 0 ? trips.slice(0, 2).map(t => ({
    id: t.id,
    title: t.title,
